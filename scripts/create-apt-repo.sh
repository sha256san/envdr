...
REPO_DIR="docs/apt"
PKG_DEB="dist/envdoctor_0.1.0_amd64.deb"
...
cp dist/envdoctor_0.1.0_amd64.deb "${REPO_DIR}/pool/main/e/envdoctor/"
cp dist/envdr_0.1.0_amd64.deb "${REPO_DIR}/pool/main/e/envdoctor/"

cd "${REPO_DIR}"

PKG_FILE="pool/main/e/envdoctor/envdoctor_0.1.0_amd64.deb"
...
Filename: pool/main/e/envdoctor/envdr_0.1.0_amd64.deb
Size: $(stat -c%s "pool/main/e/envdoctor/envdr_0.1.0_amd64.deb")
MD5sum: $(md5sum "pool/main/e/envdoctor/envdr_0.1.0_amd64.deb" | awk '{print $1}')
SHA1: $(sha1sum "pool/main/e/envdoctor/envdr_0.1.0_amd64.deb" | awk '{print $1}')
SHA256: $(sha256sum "pool/main/e/envdoctor/envdr_0.1.0_amd64.deb" | awk '{print $1}')
EOF
